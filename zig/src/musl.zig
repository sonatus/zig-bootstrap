...
const src_files = [_][]const u8{
    ...
    "musl/src/malloc/mimalloc/libc.c",
    "musl/src/malloc/mimalloc/segment-map.c",
    "musl/src/malloc/mimalloc/random.c",
    "musl/src/malloc/mimalloc/heap.c",
    "musl/src/malloc/mimalloc/free.c",
    "musl/src/malloc/mimalloc/options.c",
    "musl/src/malloc/mimalloc/alloc-aligned.c",
    "musl/src/malloc/mimalloc/prim.c",
    "musl/src/malloc/mimalloc/bitmap.c",
    "musl/src/malloc/mimalloc/os.c",
    "musl/src/malloc/mimalloc/page-queue.c",
    "musl/src/malloc/mimalloc/stats.c",
    "musl/src/malloc/mimalloc/alloc.c",
    "musl/src/malloc/mimalloc/arena.c",
    "musl/src/malloc/mimalloc/segment.c",
    "musl/src/malloc/mimalloc/alloc-posix.c",
    "musl/src/malloc/mimalloc/page.c",
    "musl/src/malloc/mimalloc/init.c",
    "musl/src/malloc/mimalloc/alloc-override.c",
